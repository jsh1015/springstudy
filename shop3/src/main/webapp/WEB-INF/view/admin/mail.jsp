...
<body>
<h2>메일보내기</h2>
<form name="mailform" method="post" action="mail.shop" enctype="multipart/form-data" onsubmit="return idinput chk(this)">
	...
	<table>
		...
		<tr><td>받는사람</td>
			<td><input type="text" name="recipient" size="100" value=
					'<c:forEach items="${list}" var="user">${user.username }&lt;${user.email}&gt;,</c:forEach>'></td></tr>
		...
		<tr><td colspan="2">
			...
			<script type="text/javascript">CKEDITOR.replace("contents")</script></td></tr>
